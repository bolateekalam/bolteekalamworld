...
export const CertificateGenerator = ({ 
  ...
  // Generate 4:3 Aspect Ratio (1200x900) High-Resolution Royal Certificate Canvas PNG with Official Logo
  const generateCertificateCanvas = () => {
    return new Promise((resolve) => {
      ...
      const renderRestOfCanvas = (logoImage) => {
        // 3. Top Emblem & Logo
        if (logoImage) {
          ctx.drawImage(logoImage, 560, 65, 80, 80);
        } else {
          ctx.fillStyle = '#f59e0b';
          ctx.beginPath();
          ...
          ctx.fillText('बोलती वर्ल्ड', 570, 110);
        }

        // 4. Main Headings
        ctx.fillStyle = '#0e2238';
        ctx.font = 'bold 44px serif';
        const mainHeader = 'बोलती वर्ल्ड';
        ...
        let line1 = 'बोलती वर्ल्ड (Bolti World) डिजिटल साहित्यिक मंच पर आपका हार्दिक स्वागत व अभिनंदन है।';
        ...
        if (certType.includes('30 Days') || certType.includes('मासिक काव्य साधना')) {
          line1 = 'ने बोलती वर्ल्ड (Bolti World) मंच पर लगातार 30 दिन की अखंड दैनिक साहित्यिक उपस्थिति';
          ...
          line1 = `ने बोलती वर्ल्ड (Bolti World) मंच पर निरंतर ${requiredStreak || 60} दिनों की अटूट सक्रियता व काव्य साधना`;
          ...
          line1 = 'ने बोलती वर्ल्ड (Bolti World) मंच पर 50 उत्कृष्ट काव्य रचनाएँ प्रकाशित कर साहित्यिक साधना';
        ...
        // 8. 5 Signatures at Bottom (Exact Signatories)
        ...
        ctx.fillText(`प्रमाणपत्र क्रमांक: ${certId} • बोलती वर्ल्ड डिजिटल प्रमाणन (bolateeworld.in)`, 400, 835);
      ...
      logoImg.onload = () => renderRestOfCanvas(logoImg);
      logoImg.onerror = () => renderRestOfCanvas(null);
  ...
  const handleDownloadCertificate = async () => {
    ...
    try {
      ...
      link.download = `BoltiWorld_Certificate_${certId}.png`;
  ...
  const shareText = `📜 मुझे 'बोलती वर्ल्ड' (bolateeworld.in) द्वारा '${certType}' से सम्मानित किया गया है!\nरचनाकार: ${userName} (@${cleanUsername})\nप्रमाणपत्र क्रमांक: ${certId}\nदेखें: ${certShareUrl}`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/85 backdrop-blur-md animate-in fade-in duration-200 select-none">
      <div className="bg-white dark:bg-slate-900 border-2 border-amber-500/40 rounded-3xl max-w-4xl w-full p-4 sm:p-6 shadow-2xl space-y-4 max-h-[95vh] overflow-y-auto relative">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 dark:text-amber-400 font-bold">
                बोलती वर्ल्ड आधिकारिक डिजिटल सम्मान पत्र (bolateeworld.in)
              </p>
            </div>
          </div>
        ...
        {/* Certificate Container with Locked State Overlay */}
        <div className="relative overflow-hidden rounded-2xl border-4 border-[#0e2238] bg-[#fdfbf7] p-4 sm:p-8 text-slate-900 shadow-2xl space-y-4">
          ...
          <div className="flex justify-center">
            <div className="w-16 h-16 rounded-full bg-white text-[#0e2238] flex items-center justify-center shadow-md border-2 border-amber-400 p-1">
          ...
          <div className="text-center space-y-0.5">
            ...
            <h2 className="text-lg sm:text-2xl font-bold font-rozha text-rose-900 pt-1">
              {certType}
            </h2>
          </div>
          ...
          <div className="text-center space-y-1 py-1">
            ...
            <h3 className="text-2xl sm:text-3xl font-black font-rozha text-[#0e2238]">
              {userName}
            </h3>
          ...
          <div className="text-center text-xs sm:text-sm text-slate-800 leading-relaxed font-serif max-w-2xl mx-auto space-y-1 px-2">
            {certType.includes('30 Days') || certType.includes('मासिक काव्य साधना') ? (
              <>
                <p>
                  ने <strong>बोलती वर्ल्ड (Bolti World)</strong> मंच पर लगातार 30 दिन की अखंड दैनिक साहित्यिक उपस्थिति और काव्य साधना पूर्ण कर अनुपम निष्ठा का परिचय दिया है।
                </p>
                <p>
              ...
              <>
                <p>
                  ने <strong>बोलती वर्ल्ड (Bolti World)</strong> मंच पर निरंतर {requiredStreak} दिनों की अटूट सक्रियता व काव्य साधना पूर्ण कर साहित्य जगत में विशिष्ट कीर्तिमान स्थापित किया है।
                </p>
                <p>
              ...
              <>
                <p>
                  ने <strong>बोलती वर्ल्ड (Bolti World)</strong> मंच पर 50 उत्कृष्ट काव्य रचनाएँ प्रकाशित कर साहित्यिक साधना का अद्भुत परिचय दिया है।
                </p>
                <p>
              ...
              <>
                <p>
                  <strong>बोलती वर्ल्ड (Bolti World)</strong> डिजिटल साहित्यिक मंच पर आपका हार्दिक स्वागत व अभिनंदन है।
                </p>
                <p>
          ...
          <div className="text-center text-[10px] text-slate-500 pt-1">
            प्रमाणपत्र क्रमांक: <strong>{certId}</strong> • बोलती वर्ल्ड डिजिटल प्रमाणन (bolateeworld.in)
          </div>
