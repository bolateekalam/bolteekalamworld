...
export const CertificateGenerator = ({ 
  ...
  const generateCertificateCanvas = () => {
    return new Promise((resolve) => {
      ...
      // 7. Citation Statement Text (Exact matching user request)
          ...
          <div className="text-center text-xs sm:text-sm text-slate-800 leading-relaxed font-serif max-w-2xl mx-auto space-y-1 px-2">
            {certType.includes('अर्ध-शतक') ? (
              <>
                ...
                <p>
                  आपकी सृजनशीलता व शब्दों के प्रति अटूट निष्ठा को नमन करते हुए बोलती कलम साहित्यिक परिषद गर्व के साथ आपको यह सम्मान पत्र प्रदान करती है। हम आपके यशस्वी साहित्यिक भविष्य की मंगलकामना करते हैं।
                </p>
              </>
            ) : (
              <>
