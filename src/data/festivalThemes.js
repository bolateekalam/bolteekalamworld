// Global Festival Themes Preset Dataset for BolteeKalam World
...
export const FESTIVAL_THEMES = {
  ...
  independenceDay: {
    id: 'independenceDay',
    name: '🇮🇳 15 अगस्त (80वाँ स्वतंत्रता दिवस)',
    tag: '80वाँ स्वतंत्रता दिवस विशेषांक 🇮🇳',
  ...
  rakshabandhan: {
    id: 'rakshabandhan',
    name: '🎀 रक्षाबंधन पर्व विशेषांक',
    tag: 'पावन रक्षाबंधन पर्व विशेषांक 🎀',
    title: 'समस्त देशवासियों को पावन रक्षाबंधन पर्व की हार्दिक शुभकामनाएँ!',
  ...
  janmashtami: {
    id: 'janmashtami',
    name: '🪈 श्री कृष्ण जन्माष्टमी विशेषांक',
    tag: 'श्री कृष्ण जन्माष्टमी पर्व विशेषांक 🪈',
    title: 'नंद के आनंद भयो, जय कन्हैया लाल की! जन्माष्टमी की शुभकामनाएँ!',
  ...
  diwali: {
    id: 'diwali',
    name: '🪔 शुभ दीपावली महोत्सव',
    tag: 'शुभ दीपावली पर्व विशेषांक 🪔',
    title: 'प्रकाश एवं उल्लास के महापर्व दीपावली की हार्दिक शुभकामनाएँ!',
  ...
  holi: {
    id: 'holi',
    name: '🎨 होली पर्व विशेषांक',
    tag: 'होली एवं वसंतोत्सव विशेषांक 🎨',
    title: 'रंगों और खुशियों के पावन पर्व होली की हार्दिक शुभकामनाएँ!',
  ...
  default: {
    id: 'default',
    name: '🌸 सामान्य साहित्य थीम (कोई त्यौहार नहीं)',
    tag: 'राष्ट्रीय डिजिटल साहित्यिक मंच 🖋️',
    title: 'बोलती कलम (bolateeworld.in) — हिंदी साहित्य एवं स्वतंत्र काव्य मंच',
...
// Auto Date Calendar Theme Detector Helper
export const detectCurrentAutoFestivalTheme = () => {
  ...
  // Janmashtami (Active Aug 25 - Aug 27)
  if (month === 8 && date >= 25 && date <= 27) {
    return FESTIVAL_THEMES.janmashtami;
  }

  // Diwali (Active Oct 28 - Nov 3)
  if ((month === 10 && date >= 28) || (month === 11 && date <= 3)) {
